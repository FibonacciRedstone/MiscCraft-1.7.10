...
public class GodBow extends Item {
    ...
    public void onCreated(ItemStack i, World w, EntityPlayer p) {
        ...
        if (enchant == false) {
            i.addEnchantment(Enchantment.power, 10);
            i.addEnchantment(Enchantment.infinity, 10);
            i.addEnchantment(Enchantment.unbreaking, 10);
            i.addEnchantment(Enchantment.flame, 10);
    ...
    public void registerIcons(IIconRegister par1IconRegister) {
        this.itemIcon = par1IconRegister.registerIcon("MiscCraft:GodBow_standby");
        this.iconArray = new IIcon[bowPullIconNameArray.length];

        for (int i = 0; i < this.iconArray.length; ++i) {
            this.iconArray[i] = par1IconRegister.registerIcon("MiscCraft:GodBow" + "_" + bowPullIconNameArray[i]);
        }
    }
